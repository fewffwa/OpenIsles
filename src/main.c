...
RECOMP_CALLBACK("*", dk64recomp_every_frame) void unlock_extras_menu(void) {
    ...
    setFlag(i, TRUE, FLAG_TYPE_PERM);
        ...
        setFlag(0x6, TRUE, FLAG_TYPE_PERM);
        setFlag(0x42, TRUE, FLAG_TYPE_PERM);
        setFlag(0x46, TRUE, FLAG_TYPE_PERM);
        setFlag(0x75, TRUE, FLAG_TYPE_PERM);
        setFlag(0x179, TRUE, FLAG_TYPE_PERM);
}